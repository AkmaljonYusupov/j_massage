        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          >
            ...
            <button
              ...
              className="hover-fill fill-sage-dark mt-6 inline-flex h-12 items-center justify-center gap-2.5 rounded-full bg-revoza-sage px-7 text-[15px] font-bold text-white transition-transform duration-300 hover:-translate-y-0.5 disabled:pointer-events-none disabled:opacity-60"
            >
              {status === "sending" ? (
